...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="index.php?action=CategoryController_manageCategories">Categories</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<?php
$i = 1;
$url = "index.php?action=CategoryController_manageCategories&currentpage=" . $this->currentpage;
...
foreach ($this->categories as $row) {
    ...
    echo "</td>";
    echo "<td>";
    echo '<button><a href="index.php?action=CategoryController_editCategory&id=' . $row["id"] . '">Edit</a></button>';
    echo "</td>";
    echo "<td>";

    echo '<button onclick="confirmDeleteCategory(' . $row["id"] . ')">Delete</button>';
